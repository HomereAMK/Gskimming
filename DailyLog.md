...
srun --cpus-per-task=10 --mem=80g --time=70:00:00 --pty bash
srun --cpus-per-task=10 --mem=30g --time=30:00:00 --pty bash

srun --cpus-per-task=30 --mem=90g --time=100:00:00 --pty bash
